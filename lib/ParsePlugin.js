...
module.exports = class ParsePlugin {
	...
	constructor(source, requestOptions, target) {
		...
		this.target = target;
		// console.log("\n\nParsePlugin constructor...");
		// console.log('source: ', source);
		// console.log('requestOptions: ', requestOptions);
		// console.log('target: ', target);
		// console.log("ParsePlugin constructor end...\n\n");
	}
	...
	apply(resolver) {
		...
		resolver
			...
			.tapAsync("ParsePlugin", (request, resolveContext, callback) => {
				// Args of Resolver.js below are the arguments passed to this function!!!
				// return hook.callAsync(request, innerContext, (err, result) => {
				// console.log("\n\nParsePlugin tapAsync...");
				// console.log('request: ', request);
				// console.log('resolveContext: ', resolveContext);
				// console.log('callback: ', callback.toString());
				// console.log("ParsePlugin tapAsync end...\n\n");

				const parsed = resolver.parse(/** @type {string} */ (request.request));
				// console.log('parsed in ParsePlugin.js: ', parsed);
				/** @type {ResolveRequest} */
