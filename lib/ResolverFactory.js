...
exports.createResolver = function (options) {
	...
	// console.log("resolve-as-module is pushed.\n\n")
	// console.log("resolveToContext: ", resolveToContext); // This was false!!
	// resolve-as-module
	if (!resolveToContext) {
		plugins.push(
			new ConditionalPlugin(
	...
	/// This block will tap all plugins to the appropriate hook of Resolver.
	for (const plugin of plugins) {
		if (typeof plugin === "function") {
			/** @type {function(this: Resolver, Resolver): void} */
			(plugin).call(resolver, resolver);
		} else if (plugin) {
			// if (plugin && plugin.source && plugin.source === "resolve-as-module")
			// 	console.log({ line: 698, plugin})

			// Generally this will be called.
